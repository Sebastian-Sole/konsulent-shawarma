...
const LazyMapSection = lazy(() => import("@/components/map-section"));
		...
		<div className="relative h-dvh w-full">
			<Suspense fallback={<div className="h-full w-full bg-[#1a1a2e]" />}>
				<LazyMapSection
					...
					center={NORWAY_CENTER}
					zoom={NORWAY_ZOOM}
					mapStyleUrl={selectedMapTheme.url}
					firms={firms}
			...
			<Popover>
				<PopoverTrigger asChild>
					<Button
						variant="outline"
						size="icon"
						className="absolute bottom-2 left-2 z-10 size-10 rounded-full bg-background/80! hover:bg-background/70! backdrop-blur-md shadow-lg border border-border/30"
